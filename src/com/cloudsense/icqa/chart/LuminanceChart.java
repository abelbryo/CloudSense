...
public class LuminanceChart extends MotherChart{
	...
	public LuminanceChart(ViewGroup layout){
		super(); 
		this.layout = layout;
	}
	...
	public void initChart() {
		mCurrentSeries = new TimeSeries("Office 2531 - Luminance data");
	...
	public void addSampleData() {
		...
		try {
			...
			mCurrentSeries.add(date1, 150);
			mCurrentSeries.add(date2, 150);
			mCurrentSeries.add(date3, 155);
			mCurrentSeries.add(date4, 156);
			mCurrentSeries.add(date5, 140);
			mCurrentSeries.add(date6, 150);
			mCurrentSeries.add(date7, 132);
			mCurrentSeries.add(date8, 144);
			mCurrentSeries.add(date9, 145);
			mCurrentSeries.add(date10, 140);
