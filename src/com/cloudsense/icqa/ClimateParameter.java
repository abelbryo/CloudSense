...
public class ClimateParameter extends ListFragment {
	...
	public void onCreate(Bundle savedInstanceState){
		...
		CustomArrayAdapter adapter = new CustomArrayAdapter(getActivity(), layout, mData);
	...
	public void onAttach(Activity activity){
		...
		try {
			...
			throw new ClassCastException("The parent activity should implement the interface");
		}
	}
